...
//	}
	...
	public @ResponseBody
	ResponseEntity<ResponseBodyDto<Object>> handleDoubleUsernameException(Exception ex) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
		dtoResult.setCode(ResponseCodeEnum.R_400);
	...
	public @ResponseBody
	ResponseEntity<ResponseBodyDto<Object>> authenticationException(Exception ex) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
		dtoResult.setCode(ResponseCodeEnum.R_400);
	...
	public @ResponseBody
	ResponseEntity<ResponseBodyDto<Object>> authenticationException2(Exception ex) {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseBodyDto<Object> dtoResult = new ResponseBodyDto<>();
