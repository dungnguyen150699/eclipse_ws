...
CREATE TABLE `orderdetail` (
  ...
  KEY `FK9iu7g1xs6c3u7n3ryo9yv2tyd` (`product_id`),
  CONSTRAINT `FK9iu7g1xs6c3u7n3ryo9yv2tyd` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
...
INSERT INTO `users` VALUES (1,NULL,'$2a$10$tiOnNn02j30ji/ty1fxX..wmvPmygGXqF2zccL/12qnRzJUzwjr0S',NULL,'admin');
...
-- Dump completed on 2022-07-24  8:51:24
